    ...
    <group {...props} dispose={null}>
      <EffectComposer>
        <SelectiveBloom
          ...
          luminanceThreshold={0.3} // Increased threshold to reduce processing
          luminanceSmoothing={0.7} // Reduced smoothing for performance
...
// Memoize Room component to prevent unnecessary re-renders
